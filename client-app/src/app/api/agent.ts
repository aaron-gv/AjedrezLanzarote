...
const Galleries = {
    ...
    changeImageOrder: (imageId: string, galleryId:string, order: number) => {axios.put<void>(`/gallery/imageposition/${imageId}/${galleryId}/${order}`).then(responseBody); console.log(`/gallery/imageposition/${imageId}/${galleryId}/${order}`)},
